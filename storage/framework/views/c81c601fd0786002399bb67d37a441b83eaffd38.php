        ...
        <div class="card-header"><?php echo e(__('Registro actividad')); ?></div>
          <div class="card-body">
            ...
            <form method="POST" action="/Users/hugoeguino/_ProyectoSOGA/_ProyectoSOGA" accept-charset="UTF-8" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="exampleFormControlTextarea1" class="col-md-4 col-form-label"><?php echo e(__('Descripcion Actividad')); ?></label>
              ...
              <div class="col-md-7 form-group">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" class="custom-file-input" id="customFileLang" lang="es">
